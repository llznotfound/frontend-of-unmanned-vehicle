...
import {deleteWorkingPointAction} from '../../models/planstatus/planstatus'

declare let BMap
declare function require(path: string): any
const red = require('../../assets/flag_red.png') //获取红色路径点的图标
const yellow = require('../../assets/flag_yellow.png') //获取黄色路径点的图标
const green = require('../../assets/flag_green.png') //获取绿色路径点的图标
...
export default class WorkingPoint extends React.Component<WorkingPointProps, any> {
  ...
  renderPolyline() {
    ...
    workingPoint.reduce((prev, next)=>{
      ...
      ], {strokeColor:color(next.status), strokeWeight:2, strokeOpacity:0.5, strokeStyle:'dashed'})
